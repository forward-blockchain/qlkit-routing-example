(defproject qlkit-todo "0.3.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "qlkit-todo.core/on-js-reload"
               ...
               {:id "min"
                :source-paths ["src"]
                :compiler {:output-to "resources/public/js/compiled/qlkit_todo.js"
                           :main qlkit-todo.core
